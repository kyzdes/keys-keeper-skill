...
| SEC-2 secure local sinks and subprocesses | In progress: local sinks, audit metadata, clipboard pipe, argv-free macOS writes, and Linux enumeration containment implemented |
