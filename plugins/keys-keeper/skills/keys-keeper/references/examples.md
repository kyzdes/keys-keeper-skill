...
These are concrete patterns Codex and Claude should match. Each starts with the user's natural-language request and shows the exact `keys` command(s) to run.
