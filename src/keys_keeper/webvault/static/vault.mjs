...
function renderUnlock(msg) {
  ...
  const err = el("div", { class: "kkv-err", text: msg || "" });
  const btn = el("button", { class: "btn btn-primary", text: "Unlock" });
  ...
  mount(el("div", { class: "kkv-unlock" },
    ...
    el("div", { class: "kkv-field" }, el("label", { text: "account" }), uid),
    el("div", { class: "kkv-field" }, el("label", { text: "passphrase" }), pass),
    err,
    btn,
    el("div", { class: "kkv-link", text: "Create account →", onclick: () => renderRegister() }),
...
function renderRegister() {
  const uid = el("input", { class: "text-input", placeholder: "account", autocomplete: "username" });
  const pass = el("input", { class: "text-input", type: "password", placeholder: "vault passphrase", autocomplete: "new-password" });
  const conf = el("input", { class: "text-input", type: "password", placeholder: "confirm passphrase", autocomplete: "new-password" });
  const token = el("input", { class: "text-input", placeholder: "register token (from your admin)" });
  const err = el("div", { class: "kkv-err" });
  const btn = el("button", { class: "btn btn-primary", text: "Create account" });
  ...
  mount(el("div", { class: "kkv-unlock" },
    ...
    el("div", { class: "kkv-field" }, el("label", { text: "account" }), uid),
    el("div", { class: "kkv-field" }, el("label", { text: "passphrase" }), pass),
    el("div", { class: "kkv-field" }, el("label", { text: "confirm" }), conf),
    el("div", { class: "kkv-field" }, el("label", { text: "register token" }), token),
    err, btn,
    el("div", { class: "kkv-link", text: "← back to unlock", onclick: () => renderUnlock() })));
}
...
function renderVault(query = "") {
  ...
  mount(el("div", { class: "kkv-shell" },
    el("div", { class: "kkv-top" },
      ...
      el("button", { class: "btn btn-sm", text: "Lock", onclick: lock })),
    list));
}

function rowEl(e) {
  const icon = el("div", { class: "kkv-icon", "data-type": e.type, text: TYPE_SHORT[e.type] || "?" });
  return el("div", { class: "kkv-row", onclick: () => renderEntry(e) },
    icon,
...
function renderEntry(e) {
  ...
  mount(el("div", { class: "kkv-shell" },
    el("div", { class: "kkv-top" },
      el("div", { class: "kkv-detail-back", text: "← back", onclick: () => renderVault() }),
      el("div", { class: "grow" }),
      el("button", { class: "btn btn-sm", text: "Lock", onclick: lock })),
    el("div", { class: "kkv-list" }, el("div", { class: "kkv-inner" },
      el("div", { class: "kkv-detail-name", text: e.name }),
      el("div", { class: "field-section-title", text: "metadata" }),
      ...(fields.length ? fields : [el("div", { class: "kkv-empty", text: "—" })]),
      el("div", { class: "field-section-title", text: "secret" }),
